...
export default function ElektroNotdienst() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "@id": canonicalUrl,
    name: "Elektro-Notdienst 24/7",
    description: "Schneller Elektro-Notdienst rund um die Uhr bei Stromausfall, Kurzschluss und elektrischen Gefahrensituationen.",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Elektro-Notdienst 24/7 – Schnelle Hilfe bei Stromausfall"
        ...
        keywords={["Elektro Notdienst", "24/7 Elektriker", "Stromausfall Hilfe", "Kurzschluss Notfall", "Elektriker Notdienst"]}
