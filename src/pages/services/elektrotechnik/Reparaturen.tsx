...
export default function Reparaturen() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "@id": canonicalUrl,
    name: "Elektro-Reparaturen & Schadensbehebung",
    description: "Schnelle und zuverlässige Reparatur defekter Elektroinstallationen und Geräte durch zertifizierte Elektriker.",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Elektro-Reparaturen – Schnelle Hilfe bei Defekten"
        ...
        keywords={["Elektro Reparatur", "Elektriker Reparaturservice", "Steckdose reparieren", "Sicherung fliegt raus", "Kabelschaden beheben"]}
              ...
              <div className="mt-12 rounded-2xl bg-muted p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { label: "Elektro-Notdienst", href: "/handwerk/elektrotechnik/notdienst" },
