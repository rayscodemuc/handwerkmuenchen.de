...
export default function EMobility() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "@id": canonicalUrl,
    name: "E-Mobility & Ladeinfrastruktur",
    description: "Wallbox Installation und Ladeinfrastruktur für Unternehmen, Wohnanlagen und Privathaushalte. Förderungsberatung inklusive.",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="E-Mobility & Ladeinfrastruktur – Wallbox Installation"
        description="Wallbox Installation für Gewerbe, Wohnanlagen und Privat. Förderungsberatung, Lastmanagement und Abrechnungssysteme vom zertifizierten Fachbetrieb."
        keywords={["Wallbox Installation", "Ladestation Gewerbe", "E-Mobility Infrastruktur", "Elektroauto Ladestation", "Wallbox Tiefgarage"]}
        ...
        <section className="border-b border-border bg-background py-6">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-12 text-sm">
              <div className="flex items-center gap-2"><Car className="h-5 w-5 text-primary" /><span className="font-medium">Alle Fahrzeugmarken</span></div>
              <div className="flex items-center gap-2"><Shield className="h-5 w-5 text-primary" /><span className="font-medium">Förderungsberatung</span></div>
              <div className="flex items-center gap-2"><Award className="h-5 w-5 text-primary" /><span className="font-medium">Zertifizierte Installation</span></div>
            </div>
          </div>
        </section>
        ...
        <article className="bg-background">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="mx-auto max-w-3xl py-16 lg:py-20">
              ...
              <h2 className="text-2xl font-bold text-foreground mt-12 mb-6">Unsere Ladelösungen</h2>
              ...
              <div className="my-12 grid grid-cols-3 gap-4">
                <div className="rounded-xl bg-muted p-6 text-center">
                  <p className="text-3xl font-black text-primary">11-22</p>
                  <p className="mt-1 text-sm text-muted-foreground">kW AC-Ladeleistung</p>
                </div>
                <div className="rounded-xl bg-muted p-6 text-center">
                  <p className="text-3xl font-black text-primary">500+</p>
                  <p className="mt-1 text-sm text-muted-foreground">Installierte Wallboxen</p>
                </div>
                <div className="rounded-xl bg-muted p-6 text-center">
                  <p className="text-3xl font-black text-primary">100%</p>
                  <p className="mt-1 text-sm text-muted-foreground">Förderungsquote</p>
                </div>
              </div>

              <div className="my-12 rounded-2xl bg-primary/5 border border-primary/10 p-8">
                <h3 className="font-bold text-foreground">WEG & Mietobjekte: Wir kennen die Hürden</h3>
              ...
              <div className="mt-12 rounded-2xl bg-muted p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { label: "Messsysteme", href: "/handwerk/elektrotechnik/messsysteme" },
                  ].map((link, i) => (
