...
export default function SmartHome() {
  ...
  const structuredData = {
    ...
    description: "Professionelle Smart Home Installation: KNX, Loxone, intelligente Lichtsteuerung, Heizungsautomation und Sicherheitstechnik.",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Smart Home & Gebäudeautomation – Intelligentes Wohnen"
        ...
        keywords={["Smart Home Installation", "KNX Gebäudeautomation", "Intelligentes Wohnen", "Loxone Installation", "Hausautomation"]}
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-3xl">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link to="/anfrage">
                  <AnimatedButton className="bg-white text-foreground hover:bg-foreground hover:text-white">Beratung anfordern</AnimatedButton>
                </Link>
              ...
              <div className="mt-12 rounded-2xl bg-muted p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { label: "LED-Beleuchtung", href: "/handwerk/elektrotechnik/led" },
                  ].map((link, i) => (
