...
export default function Hauselektrik() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "@id": canonicalUrl,
    name: "Hauselektrik & Privatinstallationen",
    description: "Professionelle Elektroinstallationen für Privathaushalte: Steckdosen, Schalter, Beleuchtung und komplette Hausinstallationen.",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Hauselektrik & Privatinstallationen – Elektriker für Ihr Zuhause"
        ...
        keywords={["Hauselektrik", "Elektroinstallation Haus", "Steckdosen Installation", "Elektriker Privathaushalt", "Hausinstallation Elektro"]}
              ...
              <div className="mt-12 rounded-2xl bg-muted p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { label: "LED-Umrüstung", href: "/handwerk/elektrotechnik/led" },
                  ].map((link, i) => (
