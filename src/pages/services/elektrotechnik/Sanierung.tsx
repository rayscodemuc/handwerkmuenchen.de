...
export default function Sanierung() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "@id": canonicalUrl,
    name: "Elektrosanierung & Modernisierung",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Elektrosanierung & Modernisierung – Altbau Elektrik"
        ...
        keywords={["Elektrosanierung", "Altbau Elektrik", "Elektromodernisierung", "FI-Schutzschalter nachrüsten", "Elektrik erneuern"]}
              ...
              <div className="mt-12 rounded-2xl bg-muted p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { label: "Hauselektrik", href: "/handwerk/elektrotechnik/hauselektrik" },
