...
export default function Sicherheitstechnik() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "@id": canonicalUrl,
    name: "Sicherheitstechnik & Videoüberwachung",
    description: "Professionelle Alarmanlagen und Videoüberwachung für Gewerbe und Wohnanlagen. VdS-zertifiziert.",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Sicherheitstechnik & Videoüberwachung – Alarmanlagen"
        ...
        keywords={["Videoüberwachung", "Alarmanlage Installation", "Sicherheitstechnik Gewerbe", "Zutrittskontrolle", "VdS Alarmanlage"]}
              ...
              <div className="mt-12 rounded-2xl bg-muted p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { label: "Klingelanlagen", href: "/handwerk/elektrotechnik/klingelanlagen" },
                  ].map((link, i) => (
