...
export default function Messsysteme() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "@id": canonicalUrl,
    name: "Zähler, Messsysteme & Energieverteilung",
    description: "Intelligente Messsysteme und moderne Energieverteilung für transparente Verbrauchserfassung in Gewerbe und Wohnanlagen.",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SEOHead
        title="Zähler, Messsysteme & Energieverteilung – Smart Meter"
        ...
        keywords={["Smart Meter", "Energieverteilung", "Zählerschrank Installation", "Unterzähler", "Messsystem Gewerbe"]}
              ...
              <div className="mt-12 rounded-2xl bg-muted p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    { label: "E-Mobility", href: "/handwerk/elektrotechnik/e-mobility" },
