...
export const metadata: Metadata = {
  ...
  description: "Professionelle Gebäudereinigung und Facility Management in Berlin. Wir koordinieren Handwerk und Service effizient aus einer Hand.",
  alternates: {
...
const city = "Berlin";
const districts = ["Mitte", "Charlottenburg", "Kreuzberg", "Prenzlauer Berg", "Friedrichshain", "Steglitz"];
const localHighlight = "Von Mitte bis Charlottenburg, von Kreuzberg bis Prenzlauer Berg – unser Berliner Team ist in allen Bezirken der Hauptstadt für Sie da.";
const heroAltText = "Zuverlässiger Hausmeisterservice und Handwerk in Berlin Mitte";
