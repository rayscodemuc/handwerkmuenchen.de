...
export const metadata: Metadata = {
  ...
  description: "Ihr Full-Service Partner für Immobilien in Hamburg. Handwerk, Reinigung und Außenanlagenpflege in Profi-Qualität.",
  alternates: {
...
const city = "Hamburg";
const districts = ["Altstadt", "HafenCity", "Eimsbüttel", "Winterhude", "Wandsbek", "Harburg"];
const localHighlight = "Von der HafenCity bis Eimsbüttel, von Winterhude bis Harburg – wir betreuen Objekte in der gesamten Hansestadt und im Umland.";
const heroAltText = "Professionelle Reinigung und Facility Management in Hamburg HafenCity";
