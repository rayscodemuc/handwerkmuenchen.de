...
export const metadata: Metadata = {
  title: "Standort Nürnberg",
  description: "Professionelle Gebäudereinigung und Facility Management in Nürnberg. Handwerk, Reinigung und Objektbetreuung aus einer Hand.",
  alternates: {
...
const city = "Nürnberg";
const districts = ["Altstadt", "St. Johannis", "Gostenhof", "Langwasser", "Röthenbach", "Zerzabelshof"];
const localHighlight = "Von der historischen Altstadt bis nach Langwasser und Röthenbach – unser Nürnberger Team betreut Objekte im gesamten Stadtgebiet und der Metropolregion.";
const heroAltText = "Professionelle Unterhaltsreinigung und Facility Management in Nürnberg";
