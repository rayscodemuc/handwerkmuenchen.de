...
export const metadata: Metadata = {
  title: "Standort Augsburg",
  description: "Professioneller Gebäudeservice in Augsburg: Reinigung, Handwerk und Facility Management aus einer Hand. Zuverlässig für Gewerbe und Privat.",
  alternates: {
...
const city = "Augsburg";
const districts = ["Innenstadt", "Lechhausen", "Oberhausen", "Haunstetten", "Göggingen", "Hochzoll"];
const localHighlight = "Von der Augsburger Innenstadt bis nach Lechhausen und Haunstetten – wir sind in allen Stadtteilen schnell vor Ort. Unser lokales Team kennt die Region und garantiert kurze Wege.";
const heroAltText = "Gebäudereinigung und Handwerksleistungen in Augsburg Innenstadt";
