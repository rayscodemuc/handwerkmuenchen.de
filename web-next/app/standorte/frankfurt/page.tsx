...
export const metadata: Metadata = {
  ...
  description: "Full-Service für Immobilien in Frankfurt am Main: Gebäudereinigung, Handwerk und Facility Management für Gewerbe- und Wohnobjekte.",
  alternates: {
    canonical: "/standorte/frankfurt",
  },
};

const city = "Frankfurt";
const districts = ["Innenstadt", "Westend", "Sachsenhausen", "Bornheim", "Bockenheim", "Niederrad"];
const localHighlight = "Vom Bankenviertel bis nach Sachsenhausen und Bornheim – wir sind in der gesamten Mainmetropole präsent. Profitieren Sie von unserer Erfahrung mit anspruchsvollen Gewerbeobjekten.";
const heroAltText = "Gebäudemanagement und Reinigungsservice für Gewerbeobjekte in Frankfurt";
