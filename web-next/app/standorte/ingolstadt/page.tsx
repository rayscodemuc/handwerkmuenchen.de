...
export const metadata: Metadata = {
  ...
  description: "Ihr Partner für Facility Management und Gebäudeservice in Ingolstadt. Reinigung, Handwerk und Außenanlagenpflege für Industrie und Gewerbe.",
  alternates: {
    canonical: "/standorte/ingolstadt",
  },
};

const city = "Ingolstadt";
const districts = ["Altstadt", "Nordwest", "Südwest", "Friedrichshofen", "Etting", "Mailing"];
const localHighlight = "Von der Altstadt bis zum Industriegebiet Nord – wir betreuen Objekte in ganz Ingolstadt. Besonders für Industrie- und Gewerbeobjekte bieten wir maßgeschneiderte Lösungen.";
const heroAltText = "Facility Management und Reinigung für Industrieobjekte in Ingolstadt";
