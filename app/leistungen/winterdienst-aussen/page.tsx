...
import { ChevronRight, Phone, Clock, Shield, FileText, Truck, Car, Snowflake, MapPin, Check, ArrowRight } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/leistungen/winterdienst-aussen",
  },
};
...
const relatedLinks = [
  ...
  { label: "Winterdienst FM", href: "/leistungen/winterdienst" },
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-3xl">
              <p className="text-sm font-medium uppercase tracking-wider text-primary-foreground/70">
                Großflächenräumung & Parkplatz-Winterdienst
              </p>
              <h1 className="mt-3 text-4xl font-black tracking-tight text-primary-foreground lg:text-5xl">
                Winterdienst
              </h1>
              <p className="mt-6 text-lg text-primary-foreground/80 leading-relaxed">
                Winterdienst für große Außenflächen mit vollständiger Haftungsübernahme. Parkplatzräumung und Streudienst mit GPS-Dokumentation.
              </p>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="mx-auto max-w-3xl py-16 lg:py-20">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Große Parkplätze, Logistikflächen und Betriebsgelände erfordern leistungsstarke Räumtechnik und zuverlässige Organisation. Wir übernehmen die Verkehrssicherungspflicht für Ihre Großflächen – mit modernen Räumfahrzeugen, GPS-Dokumentation und garantierten Räumzeiten.
              </p>
              ...
              <div className="my-10 rounded-2xl bg-primary/5 border border-primary/10 p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground">Haftungsübernahme inklusive</h3>
                    <p className="mt-2 text-muted-foreground">Vollständige Übernahme der Verkehrssicherungspflicht. GPS-dokumentiert und versichert – Sie sind zu 100 % abgesichert.</p>
                  </div>
                </div>
              </div>
