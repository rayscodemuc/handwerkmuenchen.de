          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-3xl">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link href="/anfrage">
                  <AnimatedButton>Beratung anfragen</AnimatedButton>
                </Link>
        ...
        <section className="border-b border-border bg-background py-6">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-12 text-sm">
              <div className="flex items-center gap-2"><Gauge className="h-5 w-5 text-[#3E505B]" /><span className="font-medium text-[#3E505B]">MsbG-konform</span></div>
              <div className="flex items-center gap-2"><Shield className="h-5 w-5 text-[#3E505B]" /><span className="font-medium text-[#3E505B]">Eichrechtskonform</span></div>
        ...
        <article className="bg-background">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="mx-auto max-w-3xl py-16 lg:py-20">
              ...
              <h2 className="text-2xl font-bold text-[#3E505B] mt-12 mb-6">Unsere Lösungen</h2>
              ...
              <div className="my-12 rounded-2xl bg-primary/5 border border-primary/10 p-8">
                <h3 className="font-bold text-[#3E505B]">Smart Meter Pflicht</h3>
